...
public class MainActivity extends AppCompatActivity {
    ...
    private final String IBM_USERNAME = "81d5d863-3b8d-436a-981b-6518faade595";
    private final String IBM_PASSWORD = "FmTDzfzFo6Yd";
    private final String IBM_WORKSPACE_ID = "a0e14c07-48ca-426d-8d2c-fc7e0bae8f69";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myConversationService = new ConversationService("2017-12-06", IBM_USERNAME, IBM_PASSWORD);
            ...
            public boolean onEditorAction(TextView tv, int action, KeyEvent keyEvent) {
                if (action == EditorInfo.IME_ACTION_DONE) {
                    ...
                    chatDisplayTV.append(
                            Html.fromHtml("<p><b>ME:</b> " + userStatement + "</p>")
                    );
